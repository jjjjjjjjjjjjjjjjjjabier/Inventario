...
namespace InventarioComputo.Infrastructure.Migrations
{
    ...
    [Migration("20251003080135_AddEsEmpleadoSolamente")]
    partial class AddEsEmpleadoSolamente
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("InventarioComputo.Domain.Entities.HistorialMovimiento", b =>
                {
                    ...
                    b.Property<int?>("EmpleadoAnteriorId")
                        .HasColumnType("int");

                    b.Property<int?>("EmpleadoNuevoId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("EmpleadoAnteriorId");

                    b.HasIndex("EmpleadoNuevoId");
            ...
            modelBuilder.Entity("InventarioComputo.Domain.Entities.Usuario", b =>
                {
                    ...
                    b.Property<bool>("EsEmpleadoSolamente")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("InventarioComputo.Domain.Entities.EquipoComputo", b =>
                {
                    ...
                    b.HasOne("InventarioComputo.Domain.Entities.Usuario", null)
                        .WithMany("EquiposAsignados")
            ...
            modelBuilder.Entity("InventarioComputo.Domain.Entities.HistorialMovimiento", b =>
                {
                    ...
                    b.HasOne("InventarioComputo.Domain.Entities.Empleado", "EmpleadoAnterior")
                        .WithMany()
                        .HasForeignKey("EmpleadoAnteriorId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("InventarioComputo.Domain.Entities.Empleado", "EmpleadoNuevo")
                        .WithMany()
                        .HasForeignKey("EmpleadoNuevoId")
                        .OnDelete(DeleteBehavior.NoAction);
                    ...
                    b.Navigation("EmpleadoAnterior");

                    b.Navigation("EmpleadoNuevo");
